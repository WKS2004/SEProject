...
public class SalesManager extends User {
    ...
    @Constructor
    public SalesManager(String userName, String password, String firstName, String lastName, String address, String email, String phoneNumber) {
        super(userName, password, firstName, lastName, address, email, phoneNumber, UserRoles.SALES_MANAGER);
    }
