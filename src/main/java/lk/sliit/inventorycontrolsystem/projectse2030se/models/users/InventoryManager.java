...
public class InventoryManager extends User {
    ...
    @Constructor
    public InventoryManager(String userName, String password, String firstName, String lastName, String address, String email, String phoneNumber) {
        super(userName, password, firstName, lastName, address, email, phoneNumber, UserRoles.INVENTORY_MANAGER);
    }
