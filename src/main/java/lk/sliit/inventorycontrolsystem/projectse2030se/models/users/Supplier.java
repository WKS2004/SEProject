...
public class Supplier extends User {
    ...
    public Supplier(String userName, String password, String firstName, String lastName, String address, String email, String phoneNumber) {
        super(userName, password, firstName, lastName, address, email, phoneNumber, UserRoles.SUPPLIER);
    }
