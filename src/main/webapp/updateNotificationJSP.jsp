...
<form action="${pageContext.request.contextPath}/notification/update" method="POST">
    ...
    <div class="form-group">
        <label for="paymentMethod">Target Group* : </label>
    ...
    <div class="form-group">
        <label for="activeStatus">Enable/Disable This Notification* : </label>
        <select id="activeStatus" name="activeStatus" required>
            <option value="true">Active</option>
            <option value="false">Inactive</option>
        </select>
    </div>
    <button id="update" type="submit">Update Notification</button>
</form>
<script>
